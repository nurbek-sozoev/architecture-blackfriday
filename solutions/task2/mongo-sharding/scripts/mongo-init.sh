...
docker compose exec -T shard1 mongosh --port 27018 --quiet --eval 'rs.initiate({_id:"shardRS1",members:[{_id:0,host:"shard1:27018"}]})'
...
docker compose exec -T shard2 mongosh --port 27019 --quiet --eval 'rs.initiate({_id:"shardRS2",members:[{_id:1,host:"shard2:27019"}]})'
...
echo "Adding shards"
docker compose exec -T mongos mongosh --quiet --eval 'sh.addShard("shardRS1/shard1:27018")'
docker compose exec -T mongos mongosh --quiet --eval 'sh.addShard("shardRS2/shard2:27019")'
